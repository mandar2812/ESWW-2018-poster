...
\textbf{Inputs}: Time series $x(t) \in \mathbb{R}^{d}$ \vspace{0.5\baselineskip}
...
\begin{enumerate}
    \item Application of our proposed method to the problem of solar wind propagation time. 
